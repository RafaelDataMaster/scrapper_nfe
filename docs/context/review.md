...
**Extratores disponíveis:** 16 extratores especializados + fallback genéricos
...
Método: [can_handle / _extract_valor / _extract_numero_nota / _extract_vencimento / _extract_fornecedor]
